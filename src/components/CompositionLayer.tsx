        ...
        {progression.map((chordWithDuration, index) => (
          <div
            ...
            style={{
              ...
              padding: '1rem',
              borderRadius: '6px',
              backgroundColor: selectedChordIndex === index ? 'var(--bg-selected)' :
                currentChordIndex === index && isPlaying ? 'var(--bg-playing)' : 'var(--bg-hover)',
              border: selectedChordIndex === index ? '2px solid var(--accent)' : '2px solid transparent',
              cursor: 'pointer',
              textAlign: 'center',
            }}
          >
            ...
            <div style={{ display: 'flex', gap: '0.5rem' }}>
              ...
              <button
                ...
                style={{
                  flex: 1,
                  padding: '0.5rem',
                  backgroundColor: progression.length <= 1 ? 'var(--disabled)' : 'var(--danger)',
                  color: 'white',
                  border: 'none',
                  borderRadius: '4px',
